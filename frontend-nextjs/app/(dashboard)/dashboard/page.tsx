    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Button
            variant="outline"
            className="h-auto py-4 flex-col gap-2 hover:bg-blue-500/5 hover:border-blue-500"
            asChild
          >
            <a href="/timercards">
          ...
          <Button
            variant="outline"
            className="h-auto py-4 flex-col gap-2 hover:bg-emerald-500/5 hover:border-emerald-500"
            asChild
          >
            <a href="/candidates">
          ...
          <Button
            variant="outline"
            className="h-auto py-4 flex-col gap-2 hover:bg-amber-500/5 hover:border-amber-500"
            asChild
          >
            <a href="/salary">
