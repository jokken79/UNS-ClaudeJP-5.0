  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900">申請管理</h1>
          <p className="text-gray-600 mt-1">従業員からの各種申請の管理・承認</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4">
            <p className="text-sm text-gray-600 mb-1">却下</p>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">申請がありません</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-xs text-gray-500">日数</p>
                        <p className="text-sm font-medium text-gray-900">{request.total_days}日</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {request.notes && (
                    <div className="mb-4">
                      ...
                      <p className="text-sm text-gray-900 bg-gray-50 p-3 rounded-lg">{request.notes}</p>
                    </div>
                  )}
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        {request.review_notes && (
                          <p className="text-gray-600 italic">"{request.review_notes}"</p>
                        )}
                      </div>
                    </div>
                  )}
