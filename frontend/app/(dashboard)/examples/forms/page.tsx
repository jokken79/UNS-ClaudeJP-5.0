        ...
        <section className="bg-white/90 backdrop-blur-sm shadow-lg rounded-2xl border border-gray-200 p-6">
          ...
          <form className="space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-4">
              <button
                type="button"
                className="px-6 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all"
              >
                キャンセル
              </button>
              <button
                type="submit"
                className="px-6 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 transition-all shadow-lg"
              >
                登録する
              </button>
            </div>
