...
export function SidebarTree({
  ...
  const treeStructure: Record<string, { icon: LucideIcon; items: TreeNodeItem[] }> = {
    ...
    shadows: {
      icon: Shadow,
      items: [
        { id: 'shadows.sm', label: 'Shadow: SM', icon: Shadow },
        { id: 'shadows.md', label: 'Shadow: MD', icon: Shadow },
        { id: 'shadows.lg', label: 'Shadow: LG', icon: Shadow },
        { id: 'shadows.xl', label: 'Shadow: XL', icon: Shadow },
        { id: 'shadows.2xl', label: 'Shadow: 2XL', icon: Shadow },
        { id: 'shadows.inner', label: 'Shadow: Inner', icon: Shadow },
      ],
    },
  };
